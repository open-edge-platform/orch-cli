...
//
// caPath must be the path to the cluster CA certificate (PEM format).
// Copy the CA from the cluster and supply it via --orch-ca on every machine
// that runs orch-cli, e.g.:
//
//	orch-cli set host <id> --session-type kvm --session-state start --orch-ca /path/to/orch-ca.crt
// ─────────────────────────────────────────────────────────────────────────────
