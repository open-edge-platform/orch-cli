...
fetch-infra-openapi:
	...
	curl -sSL https://raw.githubusercontent.com/open-edge-platform/infra-core/sol-apiv2/apiv2/api/openapi/openapi.yaml -o pkg/rest/infra/amc-infra-core-edge-infrastructure-manager-openapi-all.yaml
