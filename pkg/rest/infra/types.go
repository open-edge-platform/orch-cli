...
type HostResource struct {
	...
	// (OPTIONAL) Six-digit user-consent code entered by the operator. Write-only; consumed by kvm-manager.
	...
	// Human-readable status message describing the current KVM session state. Set by kvm-manager only.
	...
	// WebSocket relay URL for the active KVM session. Set by kvm-manager only.
