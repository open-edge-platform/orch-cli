...
```
      --filter string                 site list filter
  -h, --help                          help for site
      --offset int32                  site list starting offset
      --order-by string               site list order by
  ...
  -o, --output-type string            output type: table, json, yaml (default "table")
      --page-size int32               site list maximum number of items
