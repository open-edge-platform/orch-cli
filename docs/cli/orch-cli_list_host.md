...
```
  ...
  -h, --help                          help for host
      --offset int32                  host list starting offset
      --order-by string               host list order by field (e.g. name, serialNumber, hostStatus, -name)
  ...
  -o, --output-type string            output type: table, json, yaml (default "table")
      --page-size int32               host list maximum number of items per page
