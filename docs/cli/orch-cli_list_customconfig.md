...
```
      --filter string                 customconfig list filter
  -h, --help                          help for customconfig
      --offset int32                  customconfig list starting offset
      --order-by string               customconfig list order by
  ...
  -o, --output-type string            output type: table, json, yaml (default "table")
      --page-size int32               customconfig list maximum number of items
```
